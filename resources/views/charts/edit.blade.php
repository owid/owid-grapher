			...
			{!! Form::open( array( 'method' => 'put' ) ) !!}
				...
				<div class="tab-content">
					...
					<section class="form-section">
						...
						<div class="form-section-content">
							<input class="form-control input-lg .col-xs-12" placeholder="Chart name" type="text" name="chart-name" />
						</div>
					</section>
					<section class="form-section">
						<div class="form-section-header">
						...
						<div class="form-section-content">
							<p class="form-section-desc">For now, choose CSV file from your computer with data to chart. Each country data should be in their own colum,time should it be first column, otherwise it's not gonna work.</p>
				...
				<div id="export-tab" class="tab-pane">
					<section class="form-section">
						...
						<div class="form-section-content">
							<p class="form-section-desc">Here will be generated html code for embedding iframe.</p>
						</div>
					</section>
				</div>
