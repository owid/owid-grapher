			...
			<div id="chart-chart-tab" class="tab-pane">
				...
				<svg xmlns="http://www.w3.org/2000/svg" class="nvd3-svg"  version="1.1">
					<g class="chart-logo-svg">
						<image class="chart-logo-svg-image logo" xlink:href="" x="0" y="0" height="50px" width="50px"></image>
						<g class="chart-logo-svg-vector" transform="scale(0.24,0.24), translate(0,0)">
