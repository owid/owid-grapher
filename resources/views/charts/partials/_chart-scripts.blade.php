...
<script src="{{ asset('js/app/views/chart/App.Views.Chart.ChartTab.js') }}?bust={!!time()!!}"></script>
<script src="{{ asset('js/app/views/chart/App.Views.Chart.DataTab.js') }}?bust={!!time()!!}"></script>
<script src="{{ asset('js/app/views/chart/App.Views.Chart.SourcesTab.js') }}?bust={!!time()!!}"></script>
