...
export const EditorColorScaleSection = observer(
    class EditorColorScaleSection extends React.Component<{
        scale: ColorScale
...
const ColorLegendSection = observer(
...
const ColorsSection = observer(
    class ColorsSection extends React.Component<{
        ...
        onBinningStrategy(
            ...
            if (binningStrategy)
                this.config.binningStrategy = binningStrategy.value
            this.props.onChange?.()
        }
...
const ColorSchemeEditor = observer(
    ...
    class NumericBinView extends React.Component<{
        ...
        onAddAfter() {
            ...
            if (index === customNumericValues.length - 1)
                ...
                const newValue =
                    (currentValue + customNumericValues[index + 1]) / 2
...
const CategoricalBinView = observer(
