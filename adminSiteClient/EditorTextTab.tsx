...
export const EditorTextTab = observer(
    class EditorTextTab extends React.Component<{ editor: ChartEditor }> {
        ...
        onChangeLogo(value: string) {
            if (value === "none") {
                ...
                this.props.editor.grapher.logo =
                ...
                <Section name="Topics">
                    <Select
                        ...
                        value={grapher.topicIds.map((topicId) => ({
                            id: topicId,
                            name:
                                this.props.allTopics.find(
                                    (t) => t.id === topicId
                                )?.name || "TOPIC NOT FOUND",
                        }))}
                        onChange={(topics) =>
                            runInAction(() => {
                                grapher.topicIds = topics.map(
                                    (topic) => topic.id
                                )
                            })
                        }
