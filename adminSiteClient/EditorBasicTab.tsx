...
const DimensionSlotView = observer(
    class DimensionSlotView extends React.Component<{
        ...
        constructor(props: { slot: DimensionSlot; editor: ChartEditor }) {
            super(props)
        ...
        private onMouseEnter(targetSlug: ColumnSlug) {
            if (
                !this.draggingColumnSlug ||
                targetSlug === this.draggingColumnSlug
            )
                return
        ...
        render() {
            ...
            const canAddMore =
                slot.allowMultiple || slot.dimensions.length === 0
...
const VariablesSection = observer(
...
export const EditorBasicTab = observer(
    class EditorBasicTab extends React.Component<{ editor: ChartEditor }> {
        constructor(props: { editor: ChartEditor }) {
            super(props)
