...
interface TextFragment {
    text: string
    style: React.SVGProps<SVGTextElement>
}
...
export function NewCategoryAnnotations({
    placedAnnotations,
}: {
    ...
    return (
        <g className="new-annotations">
            {placedAnnotations.map((placedAnnotation) => {
                return (
                    <NewCategoryAnnotation
                        key={placedAnnotation.name}
                        bounds={placedAnnotation.bounds}
                        textFragments={placedAnnotation.textFragments}
                        position={placedAnnotation.placement}
                        anchor={placedAnnotation.textAnchor}
                        arrowWidth={50} // todo
                        fontSize={placedAnnotation.fontSize}
                    />
                )
            })}
        </g>
...
function NewCategoryAnnotation({
    bounds,
    textFragments,
    fontSize,
    position = "top",
