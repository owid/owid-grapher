...
const AddTagModal = observer(
    class AddTagModal extends React.Component<{
        ...
        constructor(props: { parentId?: number; onClose: () => void }) {
            super(props)
...
export const TagsIndexPage = observer(
    class TagsIndexPage extends React.Component {
        static contextType = AdminAppContext
        context!: AdminAppContextType
                ...
                <AdminLayout title="Categories">
                    <main className="TagsIndexPage">
                        ...
                        <p>
                            ...
                            dataset can be assigned any number of tags. A tag
                            may be listed under another parent tag.
                        </p>
                            ...
                            {parentCategories.map((parent) => (
                                <section key={`${parent.id}-section`}>
                                    ...
                                    {parent.specialType === "systemParent" && (
                                        <p>
                                            These are special categories that
