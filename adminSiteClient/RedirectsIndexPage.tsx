...
export const RedirectsIndexPage = observer(
    class RedirectsIndexPage extends React.Component {
        static contextType = AdminAppContext
        context!: AdminAppContextType
            ...
            return (
                <AdminLayout title="Redirects">
                    <main className="RedirectsIndexPage">
                        ...
                        <p>
                            Redirects are automatically created when the slug of
                            a published chart is changed.
                        </p>
