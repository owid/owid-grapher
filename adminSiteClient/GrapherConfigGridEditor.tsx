...
export const GrapherConfigGridEditor = observer(
    class GrapherConfigGridEditor extends React.Component<GrapherConfigGridEditorProps> {
        ...
        constructor(props: GrapherConfigGridEditorProps) {
            ...
            makeObservable<GrapherConfigGridEditor, "resetViewStateAfterFetch" | "loadGrapherJson" | "updatePreviewToRow" | "columnDataSource" | "currentColumnFieldDescription" | "onRichTextEditorChange" | "hotSettings">(this, {
                ...
                dataFetchParameters: computed,
                resetViewStateAfterFetch: action.bound,
                loadGrapherJson: action.bound,
                updatePreviewToRow: action,
                columnDataSource: computed,
                currentColumnFieldDescription: computed,
                onRichTextEditorChange: action.bound,
                commitRichEditorChanges: action.bound,
                cancelRichEditorChanges: action.bound,
                commitOrCancelRichEditorChanges: action.bound,
                onGenericRichEditorChange: action.bound,
                editControl: computed,
                doAction: action,
                undoAction: action,
                redoAction: action,
                fieldDescriptionsMap: computed,
                defaultValues: computed,
                flattenedDataRows: computed,
                columnDataSources: computed,
                hotColumns: computed,
                updateSelection: action.bound,
                hotSettings: computed,
                clearCellContent: action.bound,
                initializeColumnSelection: action,
                setKeepEntitySelectionOnChartChange: action.bound,
                pageToPreviousPage: action.bound,
                pageToNextPage: action.bound,
                onDragEnd: action,
                columnListEyeIconClicked: action.bound,
                setCurrentColumnSet: action.bound,
                clearColumnFilter: action.bound,
                selectedRowContent: computed,
                onShowOnlyColumnsWithValuesInCurrentRow: action.bound,
        ...
        /** Computed property that combines all relevant filter, paging and offset
            ...
            the query */
        get dataFetchParameters(): FetchVariablesParameters {
            const {
                desiredPagingOffset,
                sortByAscending,
                sortByColumn,
        ...
        private resetViewStateAfterFetch(): void {
            this.undoStack = []
            this.redoStack = []
            this.selectedRow = undefined
            this.grapherElement = undefined
        }
        private loadGrapherJson(json: any): void {
        ...
        private updatePreviewToRow(): void {
        ...
        private get currentColumnFieldDescription():
            | FieldDescription
            | undefined {
        ...
        get fieldDescriptionsMap(): Map<string, FieldDescription> {
        ...
        get flattenedDataRows(): unknown[] | undefined {
        ...
        get columnDataSources(): ColumnDataSource[] {
        ...
        get filterSExpression(): Operation | undefined {
            const { filterState } = this
            const readOnlyColumns = this.config.readonlyColumns
            if (filterState) {
        ...
        get filterPanelConfigFields(): [string, SimpleField][] {
        ...
        get FilterPanelConfig(): Config | undefined {
