...
export const SuggestedChartRevisionImportPage = observer(
    class SuggestedChartRevisionImportPage extends React.Component {
            ...
            return (
                <AdminLayout>
                    <main className="SuggestedChartRevisionImportPage">
                        ...
                        <p>
                            Use this tool when you want to make changes to a
                            large number of charts. This tool allows you to
                            import chart revisions via a csv file, which must
                            then be approved using the{" "}
                        ...
                        <p className="text-danger">
                            ...
                            cause unexpected behavior. Use with caution. If you
                            find a bug, want to request a feature, or have other
        ...
        render() {
            return (
                <div className="collapsible">
                    ...
                    <div
                        className={`readme ${
                            this.expanded ? "show" : "collapse"
                        }`}
                    >
                        <h5>How to use</h5>
                        <p>
                            To submit one or more chart revisions, upload a csv
                            file in which each row represents a chart and each
                            column represents a chart config field (e.g. title,
                            subtitle, timelineMinTime, ...).
                        </p>
                        ...
                        <p>
                            ...
                            <ol>
                                ...
                                <li>
                                    Make all of your edits in the remaining
                                    cells;
                                </li>
                                <li>
                                    Upload the resulting csv using this tool.
                                </li>
                                <li>
                                    Go to the{" "}
                                    <Link to="/suggested-chart-revisions/review">
                        ...
                        <ul>
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <code>id</code>: represents a chart's id
                                        in the OWID database.
                                    </li>
                                    <li>
                                        <code>version</code>: represents a
                                        chart's version at{" "}
                                        <i>
                                            the time you retrieved it from the
                                            OWID database
                                        </i>
                                        . The version number is used to retrieve
                                        the corresponding chart config that is
                                        to be revised, so this version number
                                        MUST match an existing or old version of
                                        the corresponding chart (otherwise you
                                        will receive an error).
                                    </li>
                                </ul>
                            </li>
                            <li>
                                <b>Empty cells:</b> Empty csv cells will leave
                                the field unchanged. e.g. in example.csv, the{" "}
                                <code>title</code>, <code>timelineMinTime</code>
                                , and <code>timelineMaxTime</code> fields will
                                be left unchanged for chart <code>4766</code>.
                            </li>
                            <li>
                                <b>Null cells:</b> The following csv values will
                                be converted to <code>null</code>:{" "}
                            ...
                            <li>
                                ...
                                either{" "}
                                <code>grapher.legacyConfigAsAuthored</code> or{" "}
                                <code>jsonConfig</code> in the console.
                            </li>
                            <li>
                                ...
                                <ul>
                                    <li>
                                        NOT include the field as a column in the
                                        csv (e.g. do not include a "title"
                                        column in the csv if you do not want to
                                        change the title on any charts);
                                    </li>
                                    <li>leave the cell blank; or</li>
                                    <li>
                                        all cell values in the corresponding
                                        column must match the chart's current
                                        value (e.g. all titles in the "title"
                                        column must match each chart's current
                                        title).
                                    </li>
                                </ul>
                                In example.csv above, all fields other than
                                "title", "subtitle", "sourceDesc", "note",
                                "timelineMinTime", and "timelineMaxTime" will be
                                unchanged. For chart <code>4766</code>, the{" "}
                                <code>title</code>, <code>timelineMinTime</code>{" "}
                                and <code>timelineMaxTime</code> fields will not
                                be changed.
                            </li>
                            <li>
                                <b>Common problems:</b>
                                <ul>
                                    <li>
                                        ...
                                        if you try to upload a revision for a
                                        chart that already has a "pending" or
                                        "flagged" revision in the{" "}
                                        <Link to="/suggested-chart-revisions/review">
                                            chart approval tool
                                        </Link>
                                        . These revisions will need to first be
                                        approved or rejected before you upload
                                        your new revisions.
                                    </li>
                                    <li>
                                        You will receive an error message if 2
                                        or more rows in the uploaded csv file
                                        contain the same chart id.
                                    </li>
                                </ul>
                            </li>
                        </ul>
...
const CSVSelector = observer(
    class CSVSelector extends React.Component<{
        ...
        constructor(props: { onCSV: (csv: CSV) => void }) {
            super(props)
