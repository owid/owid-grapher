...
> extends React.Component<VariableSelectorProps<Editor>> {
    ...
    @observable.ref searchInput: string | undefined = undefined
    @observable.ref isProjection: boolean | undefined = undefined
    @observable.ref tolerance: number | undefined = undefined
