...
import { GrapherState, selectPeerCountries } from "@ourworldindata/grapher"
import {
    getAvailablePresets,
...
class QuickAddSection extends React.Component<{
    ...
    @action.bound async onSetDataRange() {
        ...
        // For slope charts, we need to ensure that both the start and end times have data
        const requiredTimes = grapherState.isSlopeChart
