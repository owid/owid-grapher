...
export const ColorSchemeSelector = observer(
...
const SortOrderSection = observer(
...
const ComparisonLineSection = observer(
    class ComparisonLineSection extends React.Component<{
        editor: ChartEditor
    }> {
        ...
        render() {
            ...
            return (
                <Section name="Comparison line">
                    <p>
                        Overlay a line onto the chart for comparison. Supports
                        basic{" "}
                    ...
                    {comparisonLines.map((comparisonLine, i) => (
                        <div key={i}>
                            {`Line ${i + 1}`}{" "}
                            <Button
                                onClick={() => this.onRemoveComparisonLine(i)}
                            >
...
export const EditorCustomizeTab = observer(
    class EditorCustomizeTab extends React.Component<{
        editor: ChartEditor
    }> {
        render() {
