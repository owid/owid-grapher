...
export function CreateDataInsightModal(props: {
    ...
    const getDataInsightImageUrl = ({ cache = false } = {}):
        | { source: ImageSource; url: string }
        | undefined => {
    ...
    const hasNarrativeChartField = useMemo(
        () => showField("narrativeChart"),
        [showField]
    )
    useEffect(() => {
            ...
            <div className="di-modal-content">
                ...
                >
                    ...
                    <FormField
                        ...
                        show={showField("authors")}
                    />

                    {(showField("narrativeChart") ||
                        showField("grapherUrl")) && (
                        <Flex gap="middle">
