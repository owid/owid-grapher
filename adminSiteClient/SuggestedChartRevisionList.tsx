...
const SuggestedChartRevisionRow = observer(
...
export const SuggestedChartRevisionList = observer(
    class SuggestedChartRevisionList extends React.Component<{
...
export const SuggestedChartRevisionStatusIcon = observer(
    class SuggestedChartRevisionStatusIcon extends React.Component<{
        status: SuggestedChartRevisionStatus
        setColor?: boolean
    }> {
        static defaultProps = {
