 ...
 * properties table: the conventional "## Notes" section heading is dropped —
 * the notes area carries its own title. Examples live in the intro by
 * convention (generator-enforced), so no stripping is needed here.
 */
