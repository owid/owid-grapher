...
refine_agent = Agent(
    ...
    system_prompt=(
        ...
        "Prefer per-person and rate measures over raw country-size totals: never promote total/"
        "absolute GDP — the spine already carries GDP per capita, which is the more meaningful "
        "per-person measure — nor similar aggregates that mostly track population size.\n"
