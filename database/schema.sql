...
) ENGINE=InnoDB AUTO_INCREMENT=3224393 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `variables` (
  ...
  CONSTRAINT `variables_fk_dsr_id_foreign` FOREIGN KEY (`fk_dsr_id`) REFERENCES `sources` (`id`),
...
-- Dump completed on 2016-07-29  5:00:32
-- MySQL dump 10.13  Distrib 5.5.47, for debian-linux-gnu (x86_64)
--
-- Host: localhost    Database: forge
-- ------------------------------------------------------
