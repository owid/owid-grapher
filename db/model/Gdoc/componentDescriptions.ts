...
> = {
    "additional-charts": {
        description:
            "A subtle block listing links to multiple additional charts.",
    ...
    "all-charts": {
        ...
        whenToUse:
            "Use on topic pages to surface every interactive chart on the topic.",
        notes: "Requires the doc to be tagged; optional heading and [.top] list of grapher URLs to prioritize (must belong to the tag).",
    ...
    "bespoke-component": {
        ...
        whenToUse:
            "Only with developer involvement; see the dedicated 'Bespoke viz' GDoc for details.",
        source: "inferred",
    },
    blockquote: {
        description:
            "A quoted excerpt from another source, with an optional citation.",
        whenToUse: "Use to cite an excerpt verbatim.",
        notes: "citation optional; if it's a URL it must start with http and becomes an HTML cite attribute, otherwise it's appended as a footer; text in [.+text].",
        source: "docs",
    },
    callout: {
        description:
        ...
        notes: "title and icon optional (only icon: info supported); [.+text] may contain only text, headings, and lists.",
        source: "docs",
    },
    chart: {
        description:
        ...
        notes: "size: narrow|wide(default)|widest; visibility: mobile|desktop; peerCountries: parentRegions|gdpPerCapita|population|dataRange|defaultSelection|neighbors; ?hideControls=true hides explorer/mdim controls; query params select mdim views.",
        source: "docs",
    },
    "chart-story": {
        description:
        ...
        whenToUse:
            "Use to walk readers through several views of related charts.",
        notes: "Each slide: narrative, chart (URL), and a {.technical} block containing a list.",
        source: "docs",
    },
    code: {
        description:
            "Displays a block of code verbatim (e.g. an example of OWID embed HTML).",
    ...
    "conditional-section": {
        ...
        whenToUse:
            "Use in templated pages like country profiles to hide sections that don't apply.",
        pageTypes: "country profiles (likely)",
        source: "inferred",
    },
    "cookie-notice": {
        description:
            "Renders the cookie notice / cookie-preferences management block.",
    ...
    cta: {
        description:
            "A very simple call-to-action link with an arrow to its right.",
    ...
    "data-callout": {
        ...
        notes: "url is a grapher URL (use ?time=... for a specific year, $entityCode in profiles); [.+content] may use $latestTime() and $latestValue(), optionally with an indicator slug argument for multi-indicator charts; any content including charts allowed; group multiple with data-callout-group.",
        source: "docs",
    },
    "data-callout-group": {
        description:
    ...
    "chart-rows": {
        ...
        notes: "optional kicker/title/source; each row needs image (filename) and url, with text content alongside.",
        source: "inferred",
    },
    "pull-chart": {
        description:
        ...
        notes: "image (filename) and url required; align: left-center|right-center; text content accompanies the thumbnail.",
        source: "inferred",
    },
    donors: {
        description:
    ...
    "entry-summary": {
        description:
            "An in-page summary / table of contents listing the sections of a (legacy) entry.",
        whenToUse:
            "Legacy component for older entries; not part of current authoring docs.",
        source: "inferred",
    },
    ...
    "explore-data-section": {
        ...
        whenToUse:
            "Use on linear topic pages, similar in spirit to gray-section.",
    ...
    "explorer-tiles": {
        description:
            "A grid of 4 link tiles to data explorers, with title and subtitle.",
        whenToUse: "Use on the homepage to feature explorers.",
        notes: "Explorers must be tagged in the admin and the tag needs an icon in the tag-icons folder.",
        pageTypes: "homepage",
        source: "docs",
    },
    ...
    "gray-section": {
        ...
        whenToUse:
            "Use to visually set off a section, e.g. an explorer with an explanation.",
    ...
    "guided-chart": {
        ...
        notes: "Links are #guide:<grapher URL>; all links must share the same slug (only query params vary); exactly one chart per section; explorers not supported; chart-rows inside become buttons.",
        source: "docs",
    },
    heading: {
        description:
        ...
        whenToUse:
            "Start primary sections with level 1, nest level 2 then 3; max 3 levels.",
    ...
    "homepage-intro": {
        ...
        notes: "[.featured-work] must contain exactly 4 articles; each has a free-text kicker; isNew: true shows a red 'NEW' pill.",
    ...
    "homepage-search": {
        ...
        whenToUse:
            "Must be added to the homepage, since the nav search bar disappears there.",
    ...
    "horizontal-rule": {
        ...
        whenToUse:
            "Generally place before any h1 that starts a new primary section.",
        notes: "Empty block; Google Docs' own 'Horizontal line' element also works.",
        source: "docs",
    },
    html: {
        description:
            "An escape hatch for raw inline HTML, e.g. styled spans or iframes.",
    ...
    image: {
        ...
        notes: "filename required; size: narrow|wide(default)|widest; visibility: mobile|desktop; smallFilename for mobile (still >=1600px wide); alt overrides admin alt text.",
        source: "docs",
    },
    "key-indicator": {
        description:
        ...
        notes: "datapageUrl must link to a grapher that is a datapage; fields: title, source (optional), [.+text].",
        pageTypes: "homepage",
        source: "docs",
    },
    ...
    "key-insights": {
        ...
        notes: "heading plus [.insights]; each insight has title and one of url (grapher), filename (image), or narrativeChartName, plus [.+content]; callouts inside should start with an h5 'What you should know about this data'.",
        pageTypes: "topic pages",
        source: "docs",
    },
    "latest-data-insights": {
        description:
            "A grey section displaying the latest 4 published data insights.",
    ...
    "narrative-chart": {
        ...
        notes: "Required field: name (the narrative chart's name); create via grapher's share menu ('Create narrative chart').",
        source: "docs",
    },
    "numbered-list": {
    ...
    "people-rows": {
        ...
        whenToUse:
            "Use when a people list should display in 2 or 4 columns on large screens.",
    ...
    person: {
        ...
        notes: "name required; optional: image (admin filename), title, url (author-page GDoc), [.+text] bio, [.socials].",
        pageTypes: "about pages",
        source: "docs",
    },
    "pill-row": {
    ...
    "prominent-link": {
        ...
        notes: "url required; title, description, thumbnail optional (required in practice for external URLs).",
        source: "docs",
    },
    "pull-quote": {
        description:
        ...
        whenToUse:
            "Use to visually highlight a key phrase alongside the paragraph it belongs to.",
        notes: "align: left|left-center|right-center|right; [.+content] holds the paragraph the quote is inserted into (required due to CSS limitations).",
        source: "docs",
    },
    recirc: {
        description:
        ...
        notes: "align: left|center|right; external links can't be mixed with internal ones (no thumbnails); title/subtitle per link optional.",
        source: "docs",
    },
    "research-and-writing": {
        ...
        notes: "Primary section mandatory; links can be gdoc or external (external need title/filename except in 'more'); hide-date: true, hide-authors: true; variant: featured for linear topic pages; {.latest} auto-pulls an author's latest articles.",
        source: "docs",
    },
    "resource-panel": {
        description:
        ...
        notes: "Fields: kicker, icon, title, buttonText, [.links] with url+subtitle; on desktop it pins to the top-right of the section regardless of placement, on mobile it appears where placed.",
        pageTypes: "linear topic pages",
        source: "docs",
    },
    script: {
        ...
        whenToUse:
            "Only with developer involvement; not part of normal authoring.",
        source: "inferred",
    },
    "sdg-grid": {
        description:
            "A grid of tiles linking to the 17 Sustainable Development Goal tracker pages.",
    ...
    "sdg-toc": {
        description:
            "A table of contents specific to the Sustainable Development Goal tracker pages.",
    ...
    "side-by-side": {
        description:
            "Two equal-width columns of content displayed side by side.",
    ...
    socials: {
        description:
            "A list of links to social media profiles (and email/website).",
        whenToUse: "Use in author-page headers and inside person blocks.",
        notes: "Each entry: url, text, type; allowed types: link, email, x, facebook, instagram, youtube, linkedin, threads, mastodon, bluesky.",
    ...
    "static-viz": {
        ...
        whenToUse:
            "Use for flagship static graphics that deserve downloadable metadata.",
    ...
    "sticky-left": {
        ...
        whenToUse:
            "Use to keep a chart visible alongside long explanatory text.",
        notes: "[.+left] and [.+right] freeform blocks; collapses to single column at the tablet breakpoint.",
        source: "docs",
    },
    "sticky-right": {
        description:
    ...
    "subscribe-banner": {
        description:
            "A small gray newsletter-subscribe block placed inline, left, or right of text.",
        whenToUse:
            "One is auto-added before the last h1 of every article and linear topic page; add manually only for custom placement.",
        notes: "align: left|center|right; disable the automatic one with hide-subscribe-banner: true in front matter.",
        source: "docs",
    },
    table: {
        description:
        ...
        whenToUse:
            "Use for small data tables; consider wrapping very large tables in an expander.",
        notes: "template: header-row|header-column|header-column-row; default 6-column span, size: wide for full width; caption supports links; rows as {.table-row} of [.+table-cell] blocks.",
        source: "docs",
    },
    text: {
        description:
        ...
        whenToUse:
            "The default for all body prose; just write text inside [+body].",
        notes: "Escape a leading colon (Blah\\:); use #dod:id links for details on demand; refs via {ref}id{/ref} or inline {ref}text{/ref}.",
        source: "docs",
    },
    "topic-page-intro": {
        description:
        ...
        notes: "Optional {.download-button} (text, url) and [.related-topics] (gdoc links, or external links with a text property); intro prose in [+.content].",
        pageTypes: "topic pages",
        source: "docs",
    },
    video: {
        ...
        notes: "url (video) and filename (poster, first frame at same aspect ratio) required; shouldLoop, shouldAutoplay, visibility, caption (links allowed) optional.",
        source: "docs",
    },
}
