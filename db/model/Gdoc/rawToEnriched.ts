    ...
    raw.map((block): EnrichedBlockText => {
        if (block.type !== "text") {
            return {
                ...
                parseErrors: [
                    {
                        message: `latest-excerpt only supports text blocks, found "${block.type}"`,
                    },
                ],
            }
        }
