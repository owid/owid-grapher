...
import {
    PROFILE_NO_ARTICLE_ENTITY_NAME,
    validateConditionalSectionLists,
} from "@ourworldindata/utils/src/profiles.js"
...
function parseConditionalSection(
    ...
    if (entity !== PROFILE_NO_ARTICLE_ENTITY_NAME) {
        return createError({
            message: `Conditional section must have entity: ${PROFILE_NO_ARTICLE_ENTITY_NAME}`,
        })
    }
