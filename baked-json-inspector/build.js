...
System.register("src/main", ["github:components/jquery@2.1.4", "npm:lodash@3.10.0", "github:mbostock/d3@3.5.6"], function (_export) {
  ...
  return {
    ...
    }, function (_npmLodash3100) {
      _ = _npmLodash3100["default"];
    }, function (_githubMbostockD3356) {
      d3 = _githubMbostockD3356["default"];
    }],
    execute: function () {
      ...
      $("#select_file").on("change", function () {
        ...
        d3.json("output/" + filename, function (error, data) {
          ...
          var total = data.occurs;

          var root = d3.select("#view").html("").classed("open", true);

          root.datum(data).call(buildTree);
