...
import { PageChronologicalRecord, SearchIndexName } from "@ourworldindata/types"
...
function shouldIndexInChronological(gdoc: {
...
export async function indexIndividualGdocInChronological(
    ...
    if (!shouldIndexInChronological(gdoc)) return
    ...
    try {
        await client.saveObjects({
            indexName,
            objects: [record as Record<string, unknown>],
        })
    } catch (e) {
