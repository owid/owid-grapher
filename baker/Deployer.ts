...
yarn testPrettierAll`
    ...
    async deploy() {
        ...
        // we don't use `yarn cleanTsc` because that only deletes files generated by an existing TS
        // file. This can then cause leftover DB migration scripts that wreak havoc.
        await this.runAndTick(`rm -rf itsJustJavascript`)
