    ...
    render() {
        return <Modal onClose={this.props.onClose} className="EditorFAQ">
            ...
            <div className="modal-body">
                ...
                <p>The version of the chart you see in the editor is the "canonical" version that reflects the current data. When published, charts are bundled together in a static build process and sent to Netlify for distribution around the world. This process takes about a minute. An indicator will appear in the top right showing the current build status.</p>
