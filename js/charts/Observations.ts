...
export default class Observations {
    ...
    mergeBy(key: string, mergeFMaybe?: (o: Observations, key: any) => any) {
        ...
        return new Observations(map(groupBy(this.data, (d: any) => d[key]), (arr: any, k: any) => mergeF(new Observations(arr), k)))
    }
