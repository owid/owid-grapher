...
export const ExplorerControlPanel = observer(
    class ExplorerControlPanel extends React.Component<{
        ...
        constructor(props: {
            ...
            makeObservable<ExplorerControlPanel, "options" | "customOnChange">(
                this,
                {
                    options: computed,
