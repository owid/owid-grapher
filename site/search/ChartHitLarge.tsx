...
export function ChartHitLarge({
    ...
    return (
        <AsDraft name="Chart (Large)" className="chart-hit-large">
            <div className="chart-hit-large__container">
                <div className="chart-hit-large__content">
                    <div className="chart-hit-large__title-container">
                        <Highlight
                            attribute="title"
                            highlightedTagName="strong"
                            className="chart-hit-large__title"
                            hit={hit}
                        />{" "}
                        <span className="chart-hit-large__variant">
                            {hit.variantName}
                        </span>
                    </div>
                    {entities.length > 0 && (
                        <ul className="chart-hit-large__entities">
                            {entities.map((entity, i) => (
                                <li
                                    key={entity}
                                    className="chart-hit-large__entity"
                                >
                                    {i === 0 && (
                                        <FontAwesomeIcon
                                            className="chart-hit-large__icon"
                                            icon={faMapMarkerAlt}
                                        />
                                    )}
                                    {entity}
                ...
                <div className="chart-hit-large__thumbnail">
                    <a
                        href={chartUrl}
                        className="chart-hit-large__thumbnail-link"
                        onClick={onClick}
                    ...
                    >
                        <div className="chart-hit-large__img-container">
                            {imgError && (
                                <div className="chart-hit-large__img-error">
                            ...
                            <img
                                key={previewUrl}
                                className={cx("chart-hit-large__img", {
                                    "chart-hit-large__img--loaded": imgLoaded,
                                    "chart-hit-large__img--error": imgError,
                                })}
                                loading="lazy"
