...
export const synonyms = [
    ...
    ["population division", "un wpp", "unwpp"],
    ...
    [
        ...
        "aids",
        "hiv/aids",
        "vih" /* spanish, french: hiv */,
        "sida" /* spanish, french: aids */,
        "vih/sida" /* spanish, french: hiv/aids */,
    ],
    ["tb", "tuberculosis"],
    ...
    ["salary", "wage", "wages", "income"],
    ["pay gap", "wage gap", "gender pay gap", "gender wage gap"],
    ["poverty", "poor"],
    ["inequality", "gini"],
