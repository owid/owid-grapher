...
describe(placeGrapherTabsInMediumHitGridLayout, () => {
    ...
    describe("when there is no data display on the right", () => {
        it("distributes tabs across 4 available grid slots", () => {
            ...
            const result = placeGrapherTabsInMediumHitGridLayout(tabs, {
            ...
            expect(result).toEqual([
                { tab: LineChart, slot: MediumHitGridSlot.Single },
                { tab: Table, slot: MediumHitGridSlot.Single },
                { tab: WorldMap, slot: MediumHitGridSlot.Single },
                { tab: DiscreteBar, slot: MediumHitGridSlot.Single },
            ])
        })
        ...
        it("limits tabs to available grid slots when there are too many", () => {
            ...
            expect(result).toEqual([
                ...
                { tab: Table, slot: MediumHitGridSlot.Single },
                { tab: WorldMap, slot: MediumHitGridSlot.Single },
                { tab: Marimekko, slot: MediumHitGridSlot.Single },
            ])
        })
        ...
        it("allocates larger slot to Table when it has many rows", () => {
            ...
            expect(result).toEqual([
                { tab: LineChart, slot: MediumHitGridSlot.Single },
                { tab: Table, slot: MediumHitGridSlot.Double },
                { tab: WorldMap, slot: MediumHitGridSlot.Single },
            ])
        })
        ...
        it("allocates triple slot to Table when it needs more space", () => {
            ...
            expect(result).toEqual([
                { tab: LineChart, slot: MediumHitGridSlot.Single },
                { tab: Table, slot: MediumHitGridSlot.Triple },
            ])
        })
        ...
        it("should give Table the maximum available space when needed", () => {
            ...
            expect(result).toEqual([
                { tab: Table, slot: MediumHitGridSlot.Quad },
            ])
        })
    })
    ...
    describe("when there is a data display on the right", () => {
        it("places first 3 tabs in main slots and remaining tabs in small slots", () => {
            ...
            expect(result).toEqual([
                ...
                { tab: Table, slot: MediumHitGridSlot.Single },
                { tab: Marimekko, slot: MediumHitGridSlot.Single },
                { tab: WorldMap, slot: MediumHitGridSlot.SmallLeft },
                { tab: DiscreteBar, slot: MediumHitGridSlot.SmallRight },
            ])
        })
