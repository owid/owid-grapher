...
export class CookieNotice extends React.Component {
    ...
    render() {
        return <div className={classnames("cookie-notice", { "open": this.mounted && !this.accepted })}>
            <div className="wrapper">
                <div className="owid-row">
                    ...
                    <div className="owid-col owid-col--lg-0 actions">
                        <a href="/privacy-policy" className="button">Read the privacy policy</a>
                        <button className="button accept" onClick={this.onAccept}><span className="icon"><FontAwesomeIcon icon={faCheck}/></span> I agree</button>
                    </div>
                </div>
            </div>
        </div>
