                ...
                <div className="wrapper">
                    <div className="owid-row">
                        ...
                        <div className="owid-col flex-2">
                            <div className="legal">
                                <p>
                                    License: All the material produced by Our
                                    World in Data, including interactive
                                    visualizations and code, are completely open
                                    access under the{" "}
                                    <a
                                    ...
                                    credited. All other material, including data
                                    produced by third parties and made available
                                    by Our World in Data, is subject to the
