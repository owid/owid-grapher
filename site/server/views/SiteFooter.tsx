            ...
            <div className="wrapper">
                <div className="owid-row flex-align-center">
                    <div className="owid-col owid-col--lg-3 owid-padding-bottom--sm-3">
                        <p>Our World in Data is free and accessible for everyone.</p>
                        <p>Help us do this work by making a donation.</p>
                    </div>
                    <div className="owid-col owid-col--lg-1">
                        <a href="/donate" className="owid-button donate-button" data-track-click data-track-note="donate-footer">
                ...
                <div className="owid-row">
                    <div className="owid-col owid-col--lg-1">
                        <ul>
                            ...
                            <li><a href="/feedback" data-track-click data-track-note="footer-navigation">Feedback</a></li>
                            ...
                            <li><a href="/privacy-policy" data-track-click data-track-note="footer-navigation">Privacy policy</a></li>
                        </ul>
                    </div>
                    <div className="owid-col owid-col--lg-1">
                        <ul>
