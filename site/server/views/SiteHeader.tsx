...
export const SiteHeader = (props: { entries?: CategoryWithEntries[], children?: any }) => {
    ...
    return <header className="site-header">
        <div className="wrapper site-navigation-wrapper">
            ...
            <ul className="site-social-links">
                <li>
                    <a href="https://twitter.com/ourworldindata" target="_blank" rel="noopener noreferrer" title="Twitter">
                        <FontAwesomeIcon icon={faTwitter} />
                    </a>
                </li>
                <li>
                    <a href="https://www.facebook.com/OurWorldinData/" target="_blank" rel="noopener noreferrer" title="Facebook">
                        <FontAwesomeIcon icon={faFacebook} />
                    </a>
                </li>
                <li>
                    <a href="mailto:info@ourworldindata.org" target="_blank" rel="noopener noreferrer" title="E-mail">
