...
export const OldSubscribePage = ({ baseUrl }: OldSubscribePageProps) => {
    return (
        <Html>
            <Head
            ...
            <body>
                <SiteHeader />
                <main className="old-subscribe-page grid grid-cols-12-full-width">
                    <h1 className="old-subscribe-page__heading display-2-semibold span-cols-6 col-start-5 span-md-cols-10 col-md-start-3 span-sm-cols-12 col-sm-start-2">
                        Subscribe to our newsletters
                    </h1>
                    <div className="span-cols-6 col-start-5 span-md-cols-10 col-md-start-3 span-sm-cols-12 col-sm-start-2">
                        <div id={OLD_SUBSCRIBE_PAGE_FORM_CONTAINER_ID}>
