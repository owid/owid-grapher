...
const DesktopTopicsMenu = observer(
    class DesktopTopicsMenu extends React.Component<{
        ...
        constructor(props: {
            ...
            makeObservable<DesktopTopicsMenu, "activeCategory" | "setCategory">(
                this,
                {
        ...
        render() {
            ...
            const { categories, isOpen, onMouseEnter, onMouseLeave } =
                this.props
...
const MobileTopicsMenu = observer(
    class MobileTopicsMenu extends React.Component<{
        categories: CategoryWithEntries[]
    }> {
        private activeCategory?: CategoryWithEntries

        constructor(props: { categories: CategoryWithEntries[] }) {
            super(props)
...
const SiteHeaderMenus = observer(
    class SiteHeaderMenus extends React.Component<{ baseUrl: string }> {
        ...
        private async getEntries() {
            const json = await fetch("/headerMenu.json", {
                method: "GET",
