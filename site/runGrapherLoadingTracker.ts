 ...
 * which is the only consumer. We expose this on the window instead of dispatching an
 * event, because a page can finish loading before the script that would listen for it
 * has run.
 *
 ...
 */
export function runGrapherLoadingTracker(): void {
