  ...
  return <html>
    ...
    <body>
        ...
        <article className={'owidArticle'}>
            <div className={'articleCover'} style={coverStyle}>
            </div>
...

        {
            ...
            <details className={'summary'} open={true}>
                ...
                {content.summary.reduce((memo: any, d: any) => {return memo + " " + d.value}, "")}
            </details>
            </div> : null
        }
        ...
        {
            content.refs ? <Footnotes d={content.refs} styles={styles} /> : null
        }

        { content.citation ? <div>
