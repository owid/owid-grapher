...
/** Card colours. "blue" is the data insight look; "white" mirrors the data
 * update card in the /latest feed so announcements don't read as insights. */
export type LatestCarouselTheme = "blue" | "white"
        ...
        >
            ...
            >
                ...
                <div className="latest-carousel__card-right">
                    ...
                    {/* Clipped under a fade with no "Continue reading" — the
                        card is one link, the way the feed's condensed cards
                        are; the fade is the affordance. */}
