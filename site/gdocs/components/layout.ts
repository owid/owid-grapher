...
const layouts: { [key in Container]: Layouts} = {
    ["default"]: {
        ...
        ["small-chart"]: "col-start-4 span-cols-8 col-md-start-3 span-md-cols-10 span-sm-cols-12 col-sm-start-2",
        ["small-chart--pull-quote--left"]: "span-cols-14 grid grid-cols-12-full-width",
        ["small-chart--pull-quote--left-center"]: "col-start-5 span-cols-6 col-md-start-3 span-md-cols-10 span-sm-cols-12 col-sm-start-2",
        ["small-chart--pull-quote--right-center"]: "col-start-5 span-cols-6 col-md-start-3 span-md-cols-10 span-sm-cols-12 col-sm-start-2",
        ["small-chart--pull-quote--right"]: "span-cols-14 grid grid-cols-12-full-width",
