                    ...
                    {grapherLink && (
                        <section className="static-viz-download-modal__section">
                            <DownloadButton
                                ...
                                description="Visit this chart on Our World in Data to explore and customize the data."
                                href={grapherLink}
...
const createDimensionsLabel = (image: ImageMetadata): string => {
    if (image.originalWidth && image.originalHeight) {
        return `Approx. ${image.originalWidth} × ${image.originalHeight}px`
    }
