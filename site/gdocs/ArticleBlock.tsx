...
const layouts: { [key in Container]: Layouts} = {
    ["default"]: {
        ...
        ["variable-chart"]: "col-start-4 span-cols-8 col-md-start-3 span-md-cols-10 span-sm-cols-12 col-sm-start-2",
    ...
    ["sticky-right-left-column"]: {
        ...
        ["variable-chart"]: "span-cols-5 col-start-1 span-md-cols-10 col-md-start-2 span-sm-cols-12 col-sm-start-1",
    ...
    ["sticky-right-right-column"]: {
        ...
        ["variable-chart"]: "span-cols-7 col-start-1 span-md-cols-10 col-md-start-2 span-sm-cols-12 col-sm-start-1",
