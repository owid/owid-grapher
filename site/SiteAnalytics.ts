...
/** The visitor's arm in the /latest sticky filters experiment, so the
 * /latest events can be split by arm without relying on GTM reading the
 * cookie. Undefined outside the experiment. */
