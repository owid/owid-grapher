...
An initial test database can be imported from `grapher_admin/fixtures/owid_data.sql`. For example, if your database is called `owid`:

`mysql -D owid < grapher_admin/fixtures/owid_data.sql`	
