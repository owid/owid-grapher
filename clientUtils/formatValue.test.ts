...
describe(formatValue, () => {
    ...
    const cases: [string, number, string, TickFormattingOptions][] = [
        ...
        ["thousand", 1000, "1k", {}],
        ["thousand rounding", 1002, "1k", {}],
        ["ten thousand", 10000, "10k", {}],
        ["hundred thousand default", 100000, "100k", {}],
        ["hundred thousand specific default", 123456, "123k", {}],
        ["hundred thousand rounding default", 12388, "12.4k", {}],
        ["hundred thousand specific decimals", 123456.789, "123k", {}],
        ...
        ["showPlus false with $ and trailingZeroes false", 1234.5678, "$1.23k", {showPlus: false, unit: "$", trailingZeroes: false}],
        ["showPlus false with $, trailingZeroes true, and spaceBeforeUnit true", 1234.5678, "$1.23k", {showPlus: false, unit: "$", trailingZeroes: true, spaceBeforeUnit: true}],
        ["showPlus true with $, trailingZeroes true, and spaceBeforeUnit true", 1234.5678, "+$1.23k", {showPlus: true, unit: "$", trailingZeroes: true, spaceBeforeUnit: true}],
    ]
