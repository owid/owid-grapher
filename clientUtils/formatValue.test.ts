...
describe(formatValue, () => {
    ...
    const cases: [string, number, string, TickFormattingOptions][] = [
        ...
        ["12345 short prefix", 12345, "12.35k", { numberAbreviation: "short" }],
        ["123456 short prefix", 123456, "123.46k", { numberAbreviation: "short" }],
        ["123456 decimal short prefix", 98712.78901, "98.71k", { numberAbreviation: "short", numDecimalPlaces: 10 }],
