...
// The OWID topic vocabulary: per-topic search terms, used to suggest narrower
// searches within a topic. It lives in the `owid-public` R2 bucket and is
// served through files.ourworldindata.org, whose worker adds CORS and a
