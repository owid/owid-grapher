...
// The admin key, needed to create collections and import documents. The
// read-only TYPESENSE_SEARCH_KEY in clientSettings is what gets shipped to the
// browser. "xyz" matches the key the local docker-compose container starts with.
