...
export const GRAPHER_TEST_NAME: string =
    serverSettings.GRAPHER_TEST_NAME ?? "owid"
export const GRAPHER_TEST_USER: string =
    serverSettings.GRAPHER_TEST_USER ?? "root"
export const GRAPHER_TEST_PASS: string = serverSettings.GRAPHER_TEST_PASS ?? ""
export const GRAPHER_TEST_HOST: string =
    serverSettings.GRAPHER_TEST_HOST ?? "localhost"
// The OWID stack uses 3307, but incase it's unset, assume user is running a local setup
export const GRAPHER_TEST_PORT: number =
    parseIntOrUndefined(serverSettings.GRAPHER_TEST_PORT) ?? 3306
