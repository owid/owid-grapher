...
ghdx_downloads_save_location = settings.BASE_DIR + '/data/health_data_cause_prevalence_incidence_by_gender_breakdown/'
...
gbd_category_name_in_db = 'Global Burden of Disease Datasets - Causes - Prevalence and Incidence - Breakdowns By Gender'  # set the name of the root category of all data that will be imported by this script
...
with transaction.atomic():
    ...
    existing_variables = Variable.objects.filter(datasetId__namespace='gbd_prevalence_by_gender').values('name')
