...
ghdx_downloads_save_location = settings.BASE_DIR + '/data/health_data_risk/'
...
gbd_category_name_in_db = 'Global Burden of Disease Datasets - Risks'  # set the name of the root category of all data that will be imported by this script
