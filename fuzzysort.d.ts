/**
 * This is patch of the original type definition included with the module, because it is lying!
 * The original has highlight(result?: Result, ...) but actually it is highlight(result: Result | null)!
 */
