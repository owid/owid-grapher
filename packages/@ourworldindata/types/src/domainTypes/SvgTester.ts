...
/**
 * One suite's run, as the admin's /admin/svgtester API reports it.
 *
 * Lives here rather than beside the route because the client needs it too, and
 * adminSiteServer already depends on adminSiteClient — importing back the other
