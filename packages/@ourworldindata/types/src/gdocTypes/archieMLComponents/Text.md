...
- `value`: The paragraph's rich text. Not written as a key — any plain
  paragraph in the Google Doc becomes this block, and its Docs formatting
  (bold, italic, links, superscript, subscript), refs, and
  details-on-demand links all carry through to the page.
