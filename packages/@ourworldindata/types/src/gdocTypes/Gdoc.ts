...
/** Kind of every OwidGdocAuthorContent key. */
export const OWID_GDOC_AUTHOR_CONTENT_KEY_KINDS = {
    type: "authored",
    title: "authored",
    role: "authored",
    bio: "authored",
    ...
    body: "authored",
    authorRoles: "computed", // from authors
} as const satisfies Record<keyof OwidGdocAuthorContent, GdocContentKeyKind>

/** Kind of every OwidGdocProfileContent key. */
export const OWID_GDOC_PROFILE_CONTENT_KEY_KINDS = {
    type: "authored",
    title: "authored",
    authors: "authored",
    scope: "authored",
    ...
    authorRoles: "computed", // from authors
    toc: "computed", // from body
    instantiatedEntity: "computed", // set when the profile is instantiated for one entity
} as const satisfies Record<keyof OwidGdocProfileContent, GdocContentKeyKind>

/** Kind of every OwidGdocAboutContent key. */
export const OWID_GDOC_ABOUT_CONTENT_KEY_KINDS = {
    type: "authored",
    title: "authored",
    excerpt: "authored",
    "featured-image": "authored",
    authors: "authored",
    "hide-nav": "authored",
    "override-title": "authored",
    body: "authored",
    refs: "authored",
    authorRoles: "computed", // from authors
} as const satisfies Record<keyof OwidGdocAboutContent, GdocContentKeyKind>

/** Kind of every OwidGdocHomepageContent key. */
export const OWID_GDOC_HOMEPAGE_CONTENT_KEY_KINDS = {
    type: "authored",
    title: "authored",
    authors: "authored",
    body: "authored",
...
export const GDOC_TEMPLATE_CONTENT_INTERFACES = {
    ...
    [OwidGdocType.Author]: {
        interfaceName: "OwidGdocAuthorContent",
        keyKinds: OWID_GDOC_AUTHOR_CONTENT_KEY_KINDS,
    },
    [OwidGdocType.Profile]: {
        interfaceName: "OwidGdocProfileContent",
        keyKinds: OWID_GDOC_PROFILE_CONTENT_KEY_KINDS,
    },
    [OwidGdocType.AboutPage]: {
        interfaceName: "OwidGdocAboutContent",
        keyKinds: OWID_GDOC_ABOUT_CONTENT_KEY_KINDS,
    },
