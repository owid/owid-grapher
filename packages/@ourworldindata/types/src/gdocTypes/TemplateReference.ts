...
export interface TemplateField {
    ...
    type: string
    optional: boolean
    /** Authored in the document, or computed during enrichment */
    kind: GdocContentKeyKind
    description?: string
}
...
export interface TemplateReference {
    ...
    /**
     * Slugs of editorially chosen published documents that exemplify the
     * type; resolved live by the admin server, and the first one rendered
     * whole on the template page.
     */
    exemplars?: string[]
    /**
