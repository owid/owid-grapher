...
export type DbRawPostGdoc = Required<
    Omit<DbInsertPostGdoc, "authoringMode">
> & {
    type?: OwidGdocType
    // Managed by the rich editor endpoints only; regular gdoc upserts leave
    // it untouched
    authoringMode?: OwidGdocAuthoringMode
    authors?: JsonString
    contentMd5: string
...
export function serializePostsGdocsRow(
    ...
    const KEYS_TO_REMOVE = [
        ...
        "type",
        "authors",
        "authoringMode", // managed by the rich editor endpoints only
        ...
        "contentMd5", // generated by the DB as md5 hash of content. We should never set this manually.
    ]
