...
export interface DbPlainArchivedExplorerVersion extends Required<DbInsertArchivedExplorerVersion> {
    id: number
}

export interface DbEnrichedArchivedExplorerVersion extends Omit<
