 ...
 * pixels without needing a browser or canvas.
 *
 * To re-measure these metrics, open devTools/fonts/generate-widths.html in a browser.
 * It uses @chenglou/pretext to measure each character at 100px and outputs the
 * widthsMap code ready to paste here.
 */
