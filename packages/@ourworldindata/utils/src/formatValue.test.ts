...
describe(formatValue, () => {
    ...
    const cases: [string, number, string, TickFormattingOptions][] = [
        ...
        [
            "123456 decimal short prefix",
            98712.78901,
            "98.71k",
            { numberAbbreviation: "short", numDecimalPlaces: 10 },
        ],
        [
            "hundred thousand short prefix decimal",
            100000.44,
            "100k",
            { numberAbbreviation: "short" },
        ],
        ...
        [
            "ten thousand long prefix",
            10000,
            "10,000",
            { numberAbbreviation: "long" },
        ],
        [
            "hundred thousand long prefix",
            100000,
            "100,000",
            { numberAbbreviation: "long" },
        ],
        [
            "hundred thousand long prefix decimal",
            100000.44,
            "100,000.44",
            { numberAbbreviation: "long" },
        ],
        [
            "million short prefix",
            1000000,
            "1M",
            { numberAbbreviation: "short" },
        ],
        [
            "billion short prefix",
            1000000000,
            "1B",
            { numberAbbreviation: "short" },
        ],
        [
            "trillion short prefix",
            1000000000000,
            "1T",
            { numberAbbreviation: "short" },
        ],
        [
            "quadrillion short prefix",
            1000000000000000,
            "1quad",
            { numberAbbreviation: "short" },
        ],
        ...
        [
            "0 decimals with abbreviation",
            1234567,
            "1.23 million",
            { numDecimalPlaces: 0, numberAbbreviation: "long" },
        ],
        [
            "1 decimal with abbreviation",
            1234567,
            "1.23 million",
            { numDecimalPlaces: 1, numberAbbreviation: "long" },
        ],
        [
            "1 decimal with short abbreviation",
            1234,
            "1.23k",
            { numDecimalPlaces: 1, numberAbbreviation: "short" },
        ],
        [
            "2 decimal with percentage",
            19.985,
            "19.98%",
            { numDecimalPlaces: 2, unit: "%" },
        ],
        ["with unit", 1, "$1", { unit: "$" }],
        ["with custom unit", 1, "1pp", { unit: "pp", spaceBeforeUnit: false }],
        [
            "with custom unit and space",
            1,
            "1 pp",
            { unit: "pp", spaceBeforeUnit: true },
        ],
        ["negative with unit", -1, "-$1", { unit: "$" }],
        ["trailingZeroes true", 1.1, "1.1", { trailingZeroes: false }],
        ["trailingZeroes false", 1.1, "1.10", { trailingZeroes: true }],
        [
            "$ spaceBeforeUnit false",
            1.1,
            "$1.1",
            { spaceBeforeUnit: false, unit: "$" },
        ],
        [
            "$ spaceBeforeUnit true",
            1.1,
            "$1.1",
            { spaceBeforeUnit: true, unit: "$" },
        ],
        [
            "% spaceBeforeUnit true",
            1.1,
        ...
        ["$ very small", 0.001, "<$0.01", { unit: "$" }],
        [
            "%compound spaceBeforeUnit false",
            1.1,
            "1.1%compound",
            { spaceBeforeUnit: false, unit: "%compound" },
        ],
        [
            "numberAbbreviation long",
            1000000000,
        ...
        [
            "numberAbbreviation million specific",
            846691846.8,
            "846.69 million",
            { numberAbbreviation: "long" },
        ],
        [
            "numberAbbreviation billion specific",
            123456789012,
            "123.46 billion",
            { numberAbbreviation: "long" },
        ],
        [
            "numberAbbreviation long with unit",
            1000000000,
            "$1 billion",
            { numberAbbreviation: "long", unit: "$" },
        ],
        [
            "numberAbbreviation short",
            1000000000,
        ...
        [
            "numberAbbreviation false very small",
            0.000000001,
            "0.000000001",
            { numberAbbreviation: false, numDecimalPlaces: 10 },
        ],
        ...
        [
            "showPlus true with % and 4 decimals",
            1.23456,
            "+1.2346%",
            { showPlus: true, numDecimalPlaces: 4, unit: "%" },
        ],
        [
            "showPlus false with $ and trailingZeroes false",
            1234.5678,
            "$1,234.57",
            { showPlus: false, unit: "$", trailingZeroes: false },
        ],
        [
            "showPlus false with $, trailingZeroes true, and spaceBeforeUnit true",
            1234.5678,
            "$1,234.57",
            {
                showPlus: false,
        ...
        [
            "showPlus true with $, trailingZeroes true, and spaceBeforeUnit true",
            1234.5678,
            "+$1,234.57",
            {
                showPlus: true,
