...
describe("rounding to a fixed number of decimals", () => {
    ...
    const cases: [string, number, string, TickFormattingOptions][] = [
        ...
        ["999999 rounding default", 999_999.999, "1 million", {}],
...
describe("rounding to significant figures", () => {
    ...
    const cases: [string, number, string, TickFormattingOptions][] = [
        ...
        ["999999 specific default", 999_999, "1.00 million", {}],
        ...
        ["abbreviationSignificantFigures raises abbreviated precision", 1_234_567, "1.2346 million", { numberAbbreviation: "long", abbreviationSignificantFigures: 5 }],
        ["abbreviationSignificantFigures never lowers it", 1_234_567, "1.23 million", { numberAbbreviation: "long", abbreviationSignificantFigures: 2 }],
        ["abbreviationSignificantFigures has no effect on written-out values", 1234, "1,230", { numberAbbreviation: false, abbreviationSignificantFigures: 5 }],
...
describe("the 'short' abbreviation bands", () => {
    ...
    const cases: [string, number, string, TickFormattingOptions][] = [
        ...
        ["rounds up across the threshold and abbreviates", 999_999.99, "1M", {}],
        ...
        ["sig-fig column written out while every digit is significant", 999, "999", { roundingMode: OwidVariableRoundingMode.significantFigures }],
        ["sig-fig column abbreviates from 10^sf", 25_240, "25.2k", { roundingMode: OwidVariableRoundingMode.significantFigures }],
        ["sig-fig abbreviations trim their zeroes", 26_000, "26k", { roundingMode: OwidVariableRoundingMode.significantFigures }],
        ["sig-fig column in the hundred thousands", 123_456, "123k", { roundingMode: OwidVariableRoundingMode.significantFigures }],
        ["sig-fig abbreviations are decimal-free below 1M", 950_000, "950k", { roundingMode: OwidVariableRoundingMode.significantFigures }],
        ["sig-fig value rounds up across 1M cleanly", 999_999, "1M", { roundingMode: OwidVariableRoundingMode.significantFigures }],
        ["sig-fig abbreviations trim zeroes in short mode", 1_500_000, "1.5M", { roundingMode: OwidVariableRoundingMode.significantFigures }],
        ["sig-fig millions keep meaningful decimals", 12_345_678, "12.3M", { roundingMode: OwidVariableRoundingMode.significantFigures }],
        ["1 sig fig abbreviates from 1k", 3_000, "3k", { roundingMode: OwidVariableRoundingMode.significantFigures, numSignificantFigures: 1 }],
        ["2 sig figs abbreviate from 1k", 3_000, "3k", { roundingMode: OwidVariableRoundingMode.significantFigures, numSignificantFigures: 2 }],
        ["4 sig figs write out the thousands they express exactly", 1_234, "1,234", { roundingMode: OwidVariableRoundingMode.significantFigures, numSignificantFigures: 4 }],
        ["4 sig figs abbreviate from 10k", 123_456, "123.5k", { roundingMode: OwidVariableRoundingMode.significantFigures, numSignificantFigures: 4 }],
        ["the derived threshold is capped at 1M", 123_456, "123,456", { roundingMode: OwidVariableRoundingMode.significantFigures, numSignificantFigures: 6 }],
    ]
    cases.forEach(([description, input, output, options]) => {
        it(description, () => {
            expect(
