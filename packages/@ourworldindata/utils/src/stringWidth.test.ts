...
describe("getPixelWidth", () => {
    it("calculates width for basic ASCII text", () => {
        const width = getPixelWidth("Hello", { font: "lato", size: 100 })
    ...
    it("handles various accented characters", () => {
        ...
        const baseWidth = getPixelWidth("e", { font: "lato", size: 100 })
        expect(getPixelWidth("é", { font: "lato", size: 100 })).toBe(baseWidth)
        expect(getPixelWidth("è", { font: "lato", size: 100 })).toBe(baseWidth)
        expect(getPixelWidth("ê", { font: "lato", size: 100 })).toBe(baseWidth)
        expect(getPixelWidth("ë", { font: "lato", size: 100 })).toBe(baseWidth)
    })

    it("scales width by font size", () => {
        const width100 = getPixelWidth("Test", { font: "lato", size: 100 })
        const width50 = getPixelWidth("Test", { font: "lato", size: 50 })
        const width200 = getPixelWidth("Test", { font: "lato", size: 200 })
    ...
    it("uses different widths for bold variant", () => {
        const regular = getPixelWidth("Test", { font: "lato", size: 100 })
    ...
    it("supports playfair display font", () => {
        const latoWidth = getPixelWidth("Test", { font: "lato", size: 100 })
    ...
    it("skips control characters", () => {
        ...
        const withoutControl = getPixelWidth("ab", { font: "lato", size: 100 })
    ...
    it("uses fallback width for unknown characters", () => {
        ...
        const xWidth = getPixelWidth("x", { font: "lato", size: 100 })
        const unknownWidth = getPixelWidth("中", { font: "lato", size: 100 })
        expect(unknownWidth).toBe(xWidth)
    })

    it("handles empty string", () => {
        const width = getPixelWidth("", { font: "lato", size: 100 })
        expect(width).toBe(0)
    })

    it("defaults to lato font when not specified", () => {
        const withFont = getPixelWidth("Test", { font: "lato", size: 100 })
