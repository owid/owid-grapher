...
// days-since-epoch internally (a representative day per month) and only differs
// from DayColumn in how it formats those values.
class MonthColumn<
    TABLE_TYPE extends CoreTable = CoreTable,
    DEF_TYPE extends CoreColumnDef = CoreColumnDef,
> extends DayColumn<TABLE_TYPE, DEF_TYPE> {
...
// A sub-yearly week column, storing days-since-epoch (a representative day per
// week). Uses ISO week numbering.
class WeekColumn<
    TABLE_TYPE extends CoreTable = CoreTable,
    DEF_TYPE extends CoreColumnDef = CoreColumnDef,
> extends DayColumn<TABLE_TYPE, DEF_TYPE> {
