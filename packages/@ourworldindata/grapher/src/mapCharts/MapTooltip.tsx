    ...
    implements MapSparklineManager
{
    ...
    @computed private get formattedValueLabel(): string | undefined {
        ...
        const customValueLabel = this.props.formatValueForTooltip(datum.value)
        if (customValueLabel !== undefined)
            return customValueLabel.formattedValue
    ...
    @computed private get roundingNotice(): FooterItem | undefined {
        ...
        const isValueLabelFormattedUsingMapColumn =
            datum &&
            formatValueForTooltip(datum.value).formattedValue === undefined &&
