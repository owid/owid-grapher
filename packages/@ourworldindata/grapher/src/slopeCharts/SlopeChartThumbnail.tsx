    ...
    implements ChartInterface, AxisManager
{
    ...
    private constructLabelSeries(
        ...
        const yAxis = toVerticalAxis(this.yAxisConfig, this.chartState, {
            yDomain: this.yDomain,
            yRange: this.bounds.yRange(),
        })

        const position = yAxis.place(value)
        const label =
    ...
    override render(): React.ReactElement | null {
        ...
        return (
            <>
                <MarkX
                    label={this.chartState.formatColumn.formatTime(xDomain[0])}
                    x={startX}
                ...
                />
                <MarkX
                    label={this.chartState.formatColumn.formatTime(xDomain[1])}
                    x={endX}
                    top={this.innerBounds.top}
                    bottom={this.innerBounds.bottom}
                    labelPadding={4}
