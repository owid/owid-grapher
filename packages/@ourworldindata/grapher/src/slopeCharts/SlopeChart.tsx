    ...
    implements ChartInterface
{
    ...
    @computed private get lineLegendPropsLeft(): Partial<LineLegendProps> {
        return {
            xAnchor: "end",
            fontWeight:
                this.manager.showLegend && this.showSeriesNamesInLineLegendLeft
                    ? 700
                    : undefined,
    ...
    private constructSingleLineLegendSeries(
        ...
        return {
            ...
            yValue: value,
            hover: this.hoverArray.state(seriesName),
    ...
    @action.bound onSlopeMouseOver(series: SlopeChartSeries): void {
        this.hoverArray.clearAllAndActivate(series.seriesName)
...
function Slope({
    ...
    const opacity = hover.background && !focus.background ? 0.3 : 1
    const color =
