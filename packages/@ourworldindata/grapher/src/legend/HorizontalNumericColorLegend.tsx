...
export function HorizontalNumericColorLegend(
    ...
    const markerStyleFor = (bin: ColorScaleBin): LegendMarkerStyle =>
        resolveLegendMarkerStyle(styleConfig, emphasisFor(bin), {
            fill: bin.color,
    ...
    const renderBin = (
        ...
        return (
            <NumericBinRect
                ...
                onPointerLeave={isHighlightOverlay ? undefined : onPointerLeave}
                onPointerUp={isHighlightOverlay ? undefined : onPointerUp(bin)}
            />
        )
    }
