...
export interface MapZoomToCountryOrContinentDropdownManager {
    mapConfig?: MapConfig
    isOnMapTab?: boolean
...
@observer
export class MapZoomToCountryOrContinentDropdown extends React.Component<{
    manager: MapZoomToCountryOrContinentDropdownManager
}> {
    private searchInput = ""
    ...
    constructor(props: {
        ...
        makeObservable<
            MapZoomToCountryOrContinentDropdown,
            "searchInput" | "localEntityNames"
        >(this, {
    ...
    static shouldShow(
        ...
        const menu = new MapZoomToCountryOrContinentDropdown({ manager })
    ...
    @computed
    private get manager(): MapZoomToCountryOrContinentDropdownManager {
    ...
    @computed private get options(): DropdownCollection<DropdownOption> {
        ...
        const countryOptions: DropdownOption[] | undefined =
