...
export interface DataTableManager {
    ...
    computedTimelineMinTime?: Time
    computedTimelineMaxTime?: Time
}
 ...
 * - valuesByEntityNames: The actual data for each column, grouped by entity
...
export interface DataTableDimension {
    ...
    valuesByEntityNames: Map<EntityName, DataTableValuesForEntity>
...
export interface DisplayDataTableDimension
    extends Omit<DataTableDimension, "valuesByEntityNames"> {
    sortable: boolean
...
/**
 * SparklineHighlight defines a specific point to emphasize within a sparkline
 * chart. Used to highlight particular time periods or values of interest,
 * such as the start/end points of a selected time range.
 */
