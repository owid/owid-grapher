...
export interface GrapherProgrammaticInterface extends GrapherInterface {
    ...
    entityYearHighlights?: EntityYearHighlight[]
    baseFontSize?: number
    staticBounds?: Bounds
        ...
        SlopeChartManager
{
     ...
     */
    @observable.ref entityYearHighlights?: EntityYearHighlight[]
    ...
    private get tableAfterAllTransformsAndFilters(): OwidTable {
        ...
        // todo: not to filter is necessary for map tooltip but not sure why
        if (this.isOnMapTab)
            return this.isFaceted
                ? table
                : table.filterByTargetTimes(
                      [endTime],
