...
// @react-spring/web types only include HTML elements, but animated()
// supports SVG elements at runtime. Cast to preserve proper JSX usage.
const AnimatedSvgG: any = animated("g" as unknown as "div")
