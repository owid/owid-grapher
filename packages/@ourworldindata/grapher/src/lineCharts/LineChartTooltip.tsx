...
export class LineChartTooltip extends React.Component<LineChartTooltipProps> {
    @computed private get chartState(): LineChartState {
        return this.props.chartState
    }

    @computed private get target(): { time: Time } | undefined {
        return this.props.tooltipState.target ?? undefined
    }

    @computed private get series(): RenderLineChartSeries[] {
        const { target } = this
        if (!target) return []
    ...
    @computed private get sortedSeries(): RenderLineChartSeries[] {
    ...
    @computed private get projectionNotice(): FooterItem | undefined {
    ...
    @computed private get titleAnnotation(): string {
    ...
    @computed private get subtitleFormat(): TooltipProps["subtitleFormat"] {
