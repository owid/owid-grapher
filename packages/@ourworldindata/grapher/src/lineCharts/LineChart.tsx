        ...
        HorizontalColorLegendManager
{
    ...
    @computed get activeX(): number[] {
        ...
        return this.manager.entityYearHighlights?.map(({ year }) => year) ?? []
    }
    ...
    @computed private get hasEntityYearHighlight(): boolean {
        const { entityYearHighlights = [] } = this.manager
        return entityYearHighlights.length > 0
    }
