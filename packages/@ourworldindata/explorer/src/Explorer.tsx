        ...
        GrapherManager
{
    ...
    @action.bound async updateGrapherFromExplorerUsingVariableIds() {
        ...
        //    operations like 'multiplyBy 539022 2' or 'divideBy 170775 other_slug'.
        //
        ...
        //       (this includes any intermediate columns needed for multi-step transforms)
            ...
            match(dimension)
                ...
                .with({ type: "slug" }, (dimension) => {
                    ...
                    for (const variableId of baseVariableIds) {
                        ...
                        if (!hasDimension) {
                            // Add the dimension to the beginning of the array
                            ...
                            dimensions.unshift({
                                ...
                                // For multi-step transforms with intermediate
                                // columns, we would ideally use DimensionProperty.table
                                // to prevent intermediate variables from appearing
                                // as chart dimensions. However, since indicator-based
                                // explorers currently only use single-step transforms
                                // (typically 'duplicate'), we can safely use the original
                                // dimension's property.
        ...
        // Slug-based dimensions first, then variable id-based dimensions
