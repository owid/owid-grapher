;( function() {
	...
	App.Views.ChartView = Backbone.View.extend({
		...
		initialize: function( options ) {
			...
			this.header = new App.Views.Chart.Header( childViewOptions );
			this.scaleSelectors = new App.Views.Chart.ScaleSelectors( childViewOptions );
			//tabs
			this.chartTab = new App.Views.Chart.ChartTab( childViewOptions );
			this.dataTab = new App.Views.Chart.DataTab( childViewOptions );
			this.sourcesTab = new App.Views.Chart.SourcesTab( childViewOptions );
			this.mapTab = new App.Views.Chart.MapTab( childViewOptions );
		...
		exportContent: function( evt ) {
			...
			for( var i = 0; i < styleSheets.length; i++ ) {
				App.Utils.inlineCssStyle( styleSheets[ i ].cssRules );
			}
