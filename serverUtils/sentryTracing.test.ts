...
import { runSentryScript, traceJob } from "./sentryTracing.js"
...
// Exercise the real SDK to verify trace context and lifecycle behavior.
// No DSN/transport: these tests never send telemetry.
Sentry.init({
    dsn: "",
    integrations: [],
    tracesSampleRate: 1,
