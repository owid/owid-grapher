...
- `CLOUDFLARE_GOOGLE_ANALYTICS_SAMPLING_RATE`
    ...
    - e.g. "0.01" for 1%
- `CLOUDFLARE_GOOGLE_ANALYTICS_SESSION_COOKIE_NAME`:
    - The cookie set by GTM for users that haven't consented to tracking
    - Found in Google Tag Manager under "Your Google tag"
    - e.g. "\_ga_ABCD1234"
