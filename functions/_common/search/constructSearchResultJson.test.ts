...
describe(selectRegionGroupByPriority, () => {
    ...
    it("selects income groups when no continents are available", () => {
        ...
        expect(selectedRegions).toContain("High-income countries")
        expect(selectedRegions).toContain("Low-income countries")
        expect(selectedRegions).toContain("Upper-middle-income countries")
    })
