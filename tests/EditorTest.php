...
EOT;
    ...
    public function testChartSlugRenameRedirect() {
        $chartId = $this->createChart([ 'title' => "Original chart", 'slug' => "original-slug" ]);
        $this->updateChart($chartId, [ 'slug' => "some-other-slug" ]);
