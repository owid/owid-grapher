...
export const ScatterPointsWithLabels = observer(
    class ScatterPointsWithLabels extends React.Component<ScatterPointsWithLabelsProps> {
        ...
        constructor(props: ScatterPointsWithLabelsProps) {
            ...
            makeObservable<ScatterPointsWithLabels, "seriesArray" | "focusedSeriesNames" | "hoveredSeriesNames" | "isLayerMode" | "bounds" | "isSubtleForeground" | "colorScale" | "sizeScale" | "fontScale" | "hideConnectedScatterLines" | "initialRenderSeries" | "renderSeries">(this, {
                ...
                isLayerMode: computed,
                bounds: computed,
                isSubtleForeground: computed,
                colorScale: computed,
                sizeScale: computed,
                fontScale: computed,
                hideConnectedScatterLines: computed,
                initialRenderSeries: computed,
                renderSeries: computed,
        ...
        private get focusedSeriesNames(): string[] {
            return intersection(
        ...
        private get hoveredSeriesNames(): string[] {
        ...
        private get isLayerMode(): boolean {
            return (
        ...
        private get colorScale(): ColorScale | undefined {
            return this.props.colorScale
        }

        private get sizeScale(): ScaleLinear<number, number> {
            return this.props.sizeScale
        }

        private get fontScale(): ScaleLinear<number, number> {
        ...
        private get hideConnectedScatterLines(): boolean {
            return this.props.hideConnectedScatterLines
        }

        // Pre-transform data for rendering
        private get initialRenderSeries(): ScatterRenderSeries[] {
        ...
        private get renderSeries(): ScatterRenderSeries[] {
