...
export const ScatterPoint = observer(
    class ScatterPoint extends React.Component<{
        ...
        render(): JSX.Element | null {
            ...
            const color =
                series.isFocus || !isLayerMode ? value.color : "#e2e2e2"
...
export const ScatterLine = observer(
    class ScatterLine extends React.Component<{
        series: ScatterRenderSeries
        isLayerMode: boolean
    }> {
        render(): JSX.Element | null {
            ...
            if (series.points.length === 1)
                return (
                    <ScatterPoint series={series} isLayerMode={isLayerMode} />
                )
