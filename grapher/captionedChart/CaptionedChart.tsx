...
export const CaptionedChart = observer(
    class CaptionedChart extends React.Component<CaptionedChartProps> {
        ...
        private get maxWidth(): number {
            return (
                this.props.maxWidth ?? this.bounds.width - OUTSIDE_PADDING * 2
            )
        }
        ...
        protected get chartHeight(): number {
            const controlsRowHeight = this.controls.length
                ? CONTROLS_ROW_HEIGHT
                : 0
            return Math.floor(
                this.bounds.height -
                ...
                <>
                    ...
                    >
                        {this.manager.detailRenderers.map((detail, i) => {
                            ...
                            yOffset +=
                                detail.height + STATIC_EXPORT_DETAIL_SPACING
...
export const StaticCaptionedChart = observer(
    class StaticCaptionedChart extends CaptionedChart {
        constructor(props: CaptionedChartProps) {
            super(props)

            makeObservable<
                StaticCaptionedChart,
                "paddedBounds" | "boundsForChart"
            >(this, {
