...
urlpatterns = [
    ...
    url(r'^grapher/entities/$', admin_views.listentities, name="listentities"),
    url(r'^grapher/entityIsoNames/validate$', admin_views.validate_iso, name="validateiso"),
    url(r'^grapher/entities/(?P<entityid>[\w]+)/$', admin_views.showentity, name="showentity"),
    url(r'^grapher/entities/(?P<entityid>[\w]+)$', admin_views.manageentity, name="manageentity"),
    url(r'^grapher/entities/(?P<entityid>[\w]+)/edit/$', admin_views.editentity, name="editentity"),
