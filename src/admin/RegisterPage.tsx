...
export default function RegisterPage(props: { inviteEmail?: string, errorMessage?: string, body: any }) {
    ...
    return <html lang="en">
        ...
        <body>
            <form method="POST">
                <h1>owid-admin</h1>
                <p>Register an account to access the <a href="https://ourworldindata.org">ourworldindata.org</a> database and chart editor.</p>
                ...
                <div className="form-group">
                    ...
                    <input name="password" type="password" className="form-control" placeholder="Password" required value={props.body.password}/>
                </div>
                <div className="form-group">
                    <label>Confirm Password</label>
                    <input name="confirmPassword" type="password" className="form-control" placeholder="Password" required value={props.body.confirmPassword}/>
                </div>
