...
export const ENV: string = (process.env.ENV === "production" || process.env.NODE_ENV === "production") ? "production" : "development"

export const ADMIN_SERVER_HOST: string = process.env.ADMIN_SERVER_HOST || "localhost"
export const ADMIN_SERVER_PORT: number = process.env.ADMIN_SERVER_PORT ? parseInt(process.env.ADMIN_SERVER_PORT) : 3030
export const BAKED_DEV_SERVER_HOST: string = process.env.BAKED_DEV_SERVER_HOST || "localhost"
export const BAKED_DEV_SERVER_PORT: number = process.env.BAKED_DEV_SERVER_PORT ? parseInt(process.env.BAKED_DEV_SERVER_PORT) : 3099
export const WEBPACK_DEV_URL: string = process.env.WEBPACK_DEV_URL || "http://localhost:8090"
...
export const GIT_DEFAULT_USERNAME: string = process.env.GIT_DEFAULT_USERNAME || "Our World in Data"
export const GIT_DEFAULT_EMAIL: string = process.env.GIT_DEFAULT_EMAIL || "info@ourworldindata.org"
...
export const DONATE_API_URL: string = process.env.DONATE_API_URL||"https://owid-donate.netlify.com/.netlify/functions/donate"