...
class Importer extends React.Component<ImportPageData> {
    ...
    render() {
        ...
        return <form className="Importer" onSubmit={this.onSubmit}>
            ...
            <p>Examples of valid layouts: <a href="http://ourworldindata.org/uploads/2016/02/ourworldindata_single-var.png">single variable</a>, <a href="http://ourworldindata.org/uploads/2016/02/ourworldindata_multi-var.png">multiple variables</a>. <span className="form-section-desc">CSV files only: <a href="https://ourworldindata.org/how-to-our-world-in-data-guide/#1-2-single-variable-datasets">csv file format guide</a>. Maximum file size: 10MB </span></p>
