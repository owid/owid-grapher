...
7. **Document the block in the writing reference** — a `.md` sidecar, a category entry, and regenerated registries are build-enforced; see `docs/gdocs-writing-reference.md` for the steps (same for new front-matter fields).
