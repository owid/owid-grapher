...
export default defineConfig({
  ...
  define: {
    ...
    "process.env.BAKED_GRAPHER_URL": JSON.stringify("https://ourworldindata.org/grapher"),
    "process.env.DATA_API_URL": JSON.stringify("https://api.ourworldindata.org/v1"),
    "process.env.CLOUDFLARE_IMAGES_URL": JSON.stringify("https://images.ourworldindata.org/public"),
  }
})
```
